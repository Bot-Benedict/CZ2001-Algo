...
import helper
custom_graph = helper.add_graph('./input/custom_graph.txt')
...
# Distance and Path to text file custom_graph_Q1_C_D.txt

f = open("./output/custom_graph_Q1_C_D.txt", "w")
f.write("K = " + str(K) + "\n\n")
for key in custom_graph.keys():
    to_write = BFS_knearest_distance(custom_graph, key, K)
    ...
    print()
f.close()
print("Output is written to text file custom_graph_Q1_C_D.txt...\n")